...
interface MaxCommitmentWarningProps {
  width?: number;
  height?: number;
  curToken?: string;
  onCloseClick?: () => void;
...
export default function MaxCommitmentWarning({
  width,
  height,
  curToken,
  onCloseClick,
}: MaxCommitmentWarningProps) {
        ...
        <div className="relative flex flex-col" style={setMainStyle()}>
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <div
              ...
              style={setTitleStyle()}
            >
              MAXIMUM <span className="uppercase">{curToken}</span> COMMITMENT
            </div>
            <div
            ...
            >
              <span>
                {curToken === 'eth' ? (
                  <span>
                    Maximum commitment cannot exceed a total of 35 ETH
                  </span>
                ) : (
                  <span>
                    Maximum commitment cannot exceed a total USD value of
                    $100,000
                  </span>
                )}
              </span>
